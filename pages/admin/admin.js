...
function renderAdminPedidos(containerId, pedidos) {
  ...
  const ordersHtml = pedidos
    .map((pedido, index) => {
              ...
              <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                  <thead class="table-light">
                    <tr><th class="w-50">Producto</th><th class="text-center">Cant.</th><th class="text-end">Total</th></tr>
                  </thead>
                  <tbody>
                    ${pedido.items
                      .map(
      ...
      return `
        ...
        config.color
                      ...
                      <div>
                        ...
                        <small class="text-muted">${pedido.tiempo} &bull; ${
        pedido.cliente
      }</small>
                      </div>
                    </div>
      ...
      } rounded-pill px-3">${config.label}</span>
                      <span class="fw-bold ${
                        pedido.estado === 'cancelado'
                          ? 'text-muted text-decoration-line-through'
                          : 'text-dark'
                      }">$${pedido.total.toFixed(2)}</span>
                    </div>
                  </div>
                </button>
              </h2>
  ...
  const layoutHtml = `
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="#">
                    <i class="bi bi-shop-window fs-4"></i><span>AdminPanel</span>
                </a>
                <div class="ms-auto d-flex align-items-center gap-3">
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center text-white fw-bold me-2" style="width: 32px; height: 32px">A</div>
            ...
            <div class="row flex-nowrap">
                ...
                <!-- Sidebar Desktop -->
                <div class="col-auto px-0 bg-white border-end shadow-sm d-none d-lg-block" style="min-height: 100vh; width: 250px;">
                    <div class="d-flex flex-column align-items-start pt-3">
                        <ul class="nav nav-pills flex-column mb-auto w-100">
                            <li class="nav-item w-100"><a href="#" class="nav-link text-dark px-4 py-3"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a></li>
                            <li class="nav-item w-100"><a href="#" class="nav-link active px-4 py-3"><i class="bi bi-bag-check-fill me-2"></i> Pedidos</a></li>
                            <li class="nav-item w-100"><a href="#" class="nav-link text-dark px-4 py-3"><i class="bi bi-grid me-2"></i> Productos</a></li>
                            <li class="nav-item w-100"><a href="#" class="nav-link text-dark px-4 py-3"><i class="bi bi-people me-2"></i> Clientes</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="offcanvas offcanvas-start bg-white" tabindex="-1" id="sidebarMenu">
                    ...
                    <div class="offcanvas-body p-0">
                        <ul class="nav nav-pills flex-column">
                             <li class="nav-item"><a href="#" class="nav-link text-dark p-3"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a></li>
                             <li class="nav-item"><a href="#" class="nav-link active p-3"><i class="bi bi-bag-check-fill me-2"></i> Pedidos</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col py-4 px-4 bg-light">
                    ...
                    <div class="row mb-4 align-items-center">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Visualiza y actualiza el estado de las órdenes.</p>
                        </div>
                        <div class="col-md-6 text-end">
                            <button class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i> Crear Pedido</button>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="card border-0 shadow-sm border-start border-4 border-success h-100">
                                <div class="card-body">
                                    <div class="text-muted small text-uppercase fw-bold">Completados</div>
                    ...
                    <ul class="nav nav-pills mb-4 gap-2 overflow-auto flex-nowrap pb-2">
                         <li class="nav-item"><button class="nav-link active rounded-pill px-4">Todos</button></li>
                         <li class="nav-item"><button class="nav-link rounded-pill px-3 border bg-white text-secondary"><i class="bi bi-inbox-fill me-1"></i> Recibidos</button></li>
                         <li class="nav-item"><button class="nav-link rounded-pill px-3 border bg-white text-secondary"><i class="bi bi-fire me-1"></i> Preparando</button></li>
                    </ul>

                    <!-- Lista de Pedidos (Accordion Dinámico) -->
                    <div class="accordion shadow-sm rounded-3 overflow-hidden" id="ordersAccordion">
                        ${ordersHtml}
                    </div>
